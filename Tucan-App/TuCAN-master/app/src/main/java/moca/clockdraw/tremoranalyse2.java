...
public class tremoranalyse2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_aufgabe.setText("Spirale nachzeichnen");
        iv_form = (ImageView)findViewById(R.id.form_iv);
        iv_form.setImageResource(R.drawable.spirale);
            ...
            public void onClick(View v) {
                ...
                handler = new Handler(new Handler.Callback() {
                    ...
                    public boolean handleMessage(Message msg) {
                        ...
                        spinner.dismiss();
                        Intent intent = new Intent(tremoranalyse2.this, task1.class);
