...
public class zeichnenUeben extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String aufgabePortrait = "Üben Sie das Zeichnen mit dem Stift";
        String aufgabeLandscape = "Üben Sie das\nZeichnen\nmit dem Stift";
        ...
        if(shallOptimize && (displayRotation == Surface.ROTATION_90 || displayRotation == Surface.ROTATION_270)) {
            ...
            tv_aufgabe.setText("Üben Sie das Zeichnen\nmit dem Stift");
        } else {
            ...
            public void onClick(View v) {
                ...
                handler = new Handler(new Handler.Callback() {
                    ...
                    public boolean handleMessage(Message msg) {
                        ...
                        spinner.dismiss();
                        Intent intent = new Intent(zeichnenUeben.this, tremoranalyse1.class);
