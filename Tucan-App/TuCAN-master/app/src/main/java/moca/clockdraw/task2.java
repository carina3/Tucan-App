...
public class task2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(shallOptimize) {
            if (rightHander){
                setContentView(R.layout.activity_task2_optimized_rechts);
            }else {
                setContentView(R.layout.activity_task2_optimized_links);
            }
            tv_aufgabe = (TextView) findViewById(R.id.aufgabe_tv);
            iv_form = (ImageView) findViewById(R.id.form_iv);
            switch (form) {
                case "Würfel":
                    tv_aufgabe.setText("Würfel nachzeichnen");
                    iv_form.setImageResource(R.drawable.wuerfel);
                    break;
                case "Quader":
                    tv_aufgabe.setText("Quader nachzeichnen");
                    iv_form.setImageResource(R.drawable.cuboidsimple);
                    break;
                case "Zylinder":
                    tv_aufgabe.setText("Zylinder nachzeichnen");
            ...
            setContentView(R.layout.activity_task2_original);
            tv_aufgabe = (TextView) findViewById(R.id.aufgabe_tv);
            iv_form = (ImageView) findViewById(R.id.form_iv);
            switch (form) {
                case "Würfel":
                    tv_aufgabe.setText("Würfel\n nach-\n zeichnen");
                    iv_form.setImageResource(R.drawable.wuerfel);
                    break;
                case "Quader":
                    tv_aufgabe.setText("Quader\n nach-\n zeichnen");
                    iv_form.setImageResource(R.drawable.cuboidsimple);
                    break;
                case "Zylinder":
                    tv_aufgabe.setText("Zylinder\n nach-\n zeichnen");
                    iv_form.setImageResource(R.drawable.zylinder_quer);
                    break;
            }
        }
        ...
        */
        ...
        resetButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int optimiert = 0;
                //shallOptimized wird nicht als übergeben daher hier stupiede gesetzt
