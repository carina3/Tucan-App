...
public class task3 extends Activity {
    ...
    private String aufgabeLandscape, aufgabePortrait;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String timeString = prefs.getString("timeString", "Error");
        final boolean rightHander = prefs.getBoolean("reightHander", false);

        aufgabeLandscape = "Eine Uhr zeichnen\n(" + timeString + ")";
        aufgabePortrait = "Eine Uhr zeichnen (" + timeString + ")";
        ...
        */
        ...
        resetButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Save image
                //file_vpOrdner = (File) getIntent().getExtras().get("ordner");
                File file_reset = new File(file_vpOrdner, getLocalClassName() + "/resets");
                ...
                SaveThread saveThread =
                        new SaveThread(file_reset, context, noteDoc, sView, events, strokes, getLocalClassName() + "_" + resetNumber,
               ...
               // file_vpOrdner = (File) getIntent().getExtras().get("ordner");
                ...
                handler = new Handler(new Handler.Callback() {
                    ...
                    public boolean handleMessage(Message msg) {
                        ...
                        spinner.dismiss();
                        Intent intent = new Intent(task3.this, MainMenu.class);
                ...
                //Let a thread do the saving stuff => heavy user experience improvement
                SaveThread saveThread =
        ...
        /*
         * The following disables strokes being drawn when the finger touches the screen.
         * However, it should be possible to also enable support for drawing strokes when the
         * SPen touches the screen while the button on the pen is pressed.
         * Enabline both somehow leads to exceptions, for which i could not manage to find a reason.
         * So this is left for future work.
         */
        sView.setToolTypeAction(SpenSurfaceView.TOOL_FINGER, SpenSurfaceView.ACTION_NONE);
        sView.setToolTypeAction(SpenSurfaceView.TOOL_SPEN, SpenSurfaceView.ACTION_STROKE);
    ...
    private void finishHoverStroke() {
        if (recordedHoverPoints > 0) { // else no points where recorded
            ...
            currentHoverStroke.setPenSize(0.5f);
    ...
    private void saveCanvasSize() {
        ...
        try {
            //Read the two lines:
            buffReader = new BufferedReader(new FileReader(ordner + "/vpData.csv"));
